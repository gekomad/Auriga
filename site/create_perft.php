...
depth: <input name="depth" type="text" id="depth" placeholder="depth" /><br>
<label id="error_depth" class="hidden">depth is a number between 2 and 100</label>
tasks: <input name="tasks" type="text" id="tasks" placeholder="tasks number" />
<label id="error_tasks" class="hidden">task is a number between 1 and 1000</label>
