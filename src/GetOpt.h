...
public:
    static void help(char **argv) {
        ...
        cout << "Generate master.ini:\t\t" << exe << " --master -generate_master_ini Ntask \"fen\" depth ini_dir\n";
        cout << "Run perft on single task:\t" << exe << " --task -start engine.ini root_dir perft_uuid task_uuid\n";
    }
