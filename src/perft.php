...
$sql="select uuid_task,engine n_engine,perc_completed,creation_date,hours from perft_tasks where uuid_perft ='".$uuid_perft."' order by perc_completed asc ,creation_date desc";
...
<?php echo "<button onclick='writeCommands(\"$uuid_perft\",ut)'>Generate command for uncompleted tasks</button>";?>
<?php
