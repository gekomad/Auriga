...
public:
    ...
    static void parse(int argc, char **argv) {
        ...
        //--master -generate_master_ini /home/geko/workspace/Auriga/src/conf/nodes/example1.ini "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1" 7 ggg@sdf.com 5002
